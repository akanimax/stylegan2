...
metric_defaults = EasyDict(
    [
        ...
        for args in [
            ...
            EasyDict(
                name="is50k",
                func_name="metrics.inception_score.IS",
                num_images=50000,
                num_splits=10,
                minibatch_per_gpu=8,
            ),
            EasyDict(
                ...
                crop=True,
                minibatch_per_gpu=4,
                Gs_overrides=dict(dtype="float32", mapping_dtype="float32"),
            ),
            EasyDict(
                name="ppl_wfull",
                func_name="metrics.perceptual_path_length.PPL",
            ...
            EasyDict(
                name="pr50k3",
                func_name="metrics.precision_recall.PR",
                num_images=50000,
                nhood_size=3,
                minibatch_per_gpu=8,
